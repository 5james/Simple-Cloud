...
class DiffieHellman:
    ...
    def __init__(self, prime_number=None, generator=None, key_length_bytes=64):
        ...
        self.__generate_private_key(key_length_bytes)
        self.__generate_public_key()
        # end_timestamp = datetime.datetime.now()
        # timestamp = end_timestamp - start_timestamp
        # print('__init__ \t' + str(timestamp))

    def __generate_private_key(self, key_length_bytes):
        # start_timestamp = datetime.datetime.now()
        self.privateKey = int.from_bytes(os.urandom(key_length_bytes), byteorder='big')
        # end_timestamp = datetime.datetime.now()
        # timestamp = end_timestamp - start_timestamp
...
if __name__ == '__main__':
    ...
    alice = DiffieHellman(key_length_bytes=64)
    bob = DiffieHellman(key_length_bytes=64)
